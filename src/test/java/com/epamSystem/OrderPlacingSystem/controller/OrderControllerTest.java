...
public class OrderControllerTest {
    ...
    public void generateBillTest() throws Exception {
        ...
        String exampleOrderJson = "{\"orderId\":\"1\",\"productDetails\":[{\"itemName\":\"Apple\",\"quantity\":\"5\",\"price\":\"5\",\"amount\":\"\"},{\"itemName\":\"Orange\",\"quantity\":\"8\",\"price\":\"3\",\"amount\":\"\"}]}";
        Product p1 = new Product("Apple",5,5.0,25.0);
        Product p2 = new Product("Orange",8,3.0,24.0);
        BillDetails mockBillDetails = new BillDetails("1", Arrays.asList(p1,p2),49.0);
        Mockito.when(
        ...
        String expectedResult = "{\"orderId\": \"1\",\"productDetails\": [{\"itemName\": \"Apple\",\"quantity\": 5,\"price\": 5.0,\"amount\": 25.0},{\"itemName\": \"Orange\",\"quantity\": 8,\"price\": 3.0,\"amount\": 24.0}],\"grandTotal\": 49.0}";
